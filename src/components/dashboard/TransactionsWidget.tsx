...
const TransactionItem: FC<TransactionItemProps> = ({
  ...
  return (
    <div
      ...
      } pl-5 py-1 flex justify-between items-center`}
    >
      <div className="flex flex-col">
        <small className="text-[10px]">20/12/2021 - 03:35pm</small>
...
const TransactionsWidget = () => {
  return (
    <div className="bg-white shadow-lg rounded-lg p-5 dark:bg-gray-600 transitions row-span-2 flex flex-col">
